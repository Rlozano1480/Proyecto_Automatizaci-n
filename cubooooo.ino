...
byte ip[] = { 192, 168, 100, 63};                       // IP Local que usted debe configurar 
      ...
      if (client.available()) {
        ...
        if (readString.length() < 100) {
         ...
         if (c == '\n') {          
           ...
           client.println("<HTML>");
           client.println("<HEAD>");
           client.println("<title>Monitoreo de envasado</title>");
           ...
           client.println("");
           client.println("<hr />");
           client.println("<H1>Universidad Politecnica de Puebla</H1>");
           client.println("<br />");  
           client.println("<H2>Control de maquinaria</H2>");
           client.println("<br />");  
           ...
           client.println("<br />"); 
           client.println("<a href=\"/?button6on\"\"> Encender Lampara</a> ");
           client.println(" | | | ");
           client.println("<a href=\"/?button6off\"\"> Apagar Lampara</a><br /> ");   
           client.println("<br />");
           
           
           client.println("<br />"); 
          
           client.println("<p>by: Daniel El Travieso</p>");  
           client.println("<br />"); 
           client.println("</BODY>");
           client.println("</HTML>");
